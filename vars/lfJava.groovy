...
**/target/surefire-reports/*-output.txt"""
    ...
    withMaven(
        ...
        sh "mvn ${config.mvnGoals} -Pq -Dorg.slf4j.simpleLogger.log.org.apache.maven.cli.transfer.Slf4jMavenTransferListener=warn -DaltDeploymentRepository=staging::default::file:${WORKSPACE}/m2repo"
    }
