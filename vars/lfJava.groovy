...
/**
 * Method to run Java jobs. Required body values:
...
**/target/surefire-reports/*-output.txt"""
    ...
    // updateJavaAlternatives may be replaced by using the withMaven block, and
    // setting the jdk there. For now, it has been minimally sketched out.
    //lfCommon.updateJavaAlternatives(javaVersion)
